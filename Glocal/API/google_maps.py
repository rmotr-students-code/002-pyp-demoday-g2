...
def get_coordinates(st_num, st_name, st_type, city, state):
    ...
    latitude, longitude coordinates. The GET request queries a specific Google
    Maps url (provided in the Google Maps API) with specific parameters
    attached (the address)."""
    r = requests.get(
