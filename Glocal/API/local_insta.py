...
def get_local_instagram(st_num,st_name,st_type,city,state):
    ...
    # queries instagram images using Instagram API with geographic parameters latitude and longitude as floats
